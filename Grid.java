...
/////////////VERTICAL
        ...
        else if(this.sqarre[0][1] == PlayerToCheck && this.sqarre[1][1] == PlayerToCheck && this.sqarre[2][1] == PlayerToCheck){
          //  System.out.println("Condition 5");
    
            return true;
        }
        else if(this.sqarre[0][2] == PlayerToCheck && this.sqarre[1][2] == PlayerToCheck && this.sqarre[2][2] == PlayerToCheck){
